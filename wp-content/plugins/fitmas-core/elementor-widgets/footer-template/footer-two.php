...
class fitmas_footer_two_widget extends Widget_Base {

    public function get_name() {

        return 'fitmas_footer_Two';
    }

    public function get_title() {
        return esc_html__( 'Fitmas Footer template Two ', 'fitmascore' );
    }
	...
	protected function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .widget-area' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .widget-area' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
                        ...
                        <div class="widget footer-widget">
                            <div class="widget-about">
                                <div class="footer-logo">
									<?php 
									if ( ! empty( $settings['about_logo_link']['url'] ) ) {
										$this->add_link_attributes( 'about_logo_link', $settings['about_logo_link'] );
									} ?>
                                    <a <?php echo $this->get_render_attribute_string( 'about_logo_link' ); ?> >
                    ...
                    <div class="col-md-6 col-xl-auto">
                        <div class="widget footer-widget">
                            ...
                            <div class="sidebar-gallery">
                                <?php foreach($settings['gallery_image'] as $gallery):?>
                                    <div class="gallery-thumb">
                                        <img src="<?php echo esc_attr( $gallery['url'] ); ?>" alt="gallery">
                                        <a href="<?php echo esc_attr( $gallery['url'] ); ?>" class="gallery-btn popup-image"> <i class="far fa-eye"></i> </a>
                                    </div>
                                <?php endforeach ?>
                            </div>
                        </div>
...
Plugin::instance()->widgets_manager->register( new fitmas_footer_two_widget );