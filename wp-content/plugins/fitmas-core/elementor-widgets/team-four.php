...
class fitmas_Team_four_Widget extends Widget_Base {

    public function get_name() {

        return 'fitmas_Team_four';
    }

    public function get_title() {
        return esc_html__( 'Fitmas Team V4', 'fitmascore' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .team-card_img img' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
		        $this->add_responsive_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .team-card_img img' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
		        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .team-card_img img' => 'min-width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .team-card_img img' => 'object-fit: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .team-card_img img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
...
Plugin::instance()->widgets_manager->register( new fitmas_Team_four_Widget );