...
class fitmas_Team_two_Widget extends Widget_Base {

    public function get_name() {

        return 'fitmas_Team_two';
    }

    public function get_title() {
        return esc_html__( 'Fitmas Team V2', 'fitmascore' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'item_scroll',
            [
                'label'     => esc_html__( 'Slide Scroll', 'fitmascore' ),
                'type'      => \Elementor\Controls_Manager::NUMBER,
                'min'       => 1,
                'max'       => 6,
                'step'      => 1,
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'toggle'    => true,
                'selectors' => [
                    '{{WRAPPER}} .team-card2' => 'text-align: {{VALUE}}',
                ],
            ]
        );
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .team-card2 .link-btn' => 'color: {{VALUE}}',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .team-card2 .link-btn',
			]
		);
        $this->add_control(
			'more_options',
        ...
        $this->add_responsive_control(
			...
			[
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .team-card2 .link-btn i' => 'color: {{VALUE}}',
				],
			]
		);
		$this->add_group_control(
			...
			[
				'name'     => 'icon_typo',
				'label'    => esc_html__( 'Number Typography', 'fitmascore' ),
				'selector' => '{{WRAPPER}} .team-card2 .link-btn i',
			]
		);
		$this->add_responsive_control(
			'number_margin',
			[
				...
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', '%', 'em'],
				'selectors'  => [ '{{WRAPPER}} .team-card2 .link-btn' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', '%', 'em'],
				'selectors'  => [ '{{WRAPPER}} .team-card2 .link-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
    ...
    protected function render() {
        ...
        ob_start();
        ?>
    <div class="team-area-2 overflow-hidden">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="team-card2">
                                ...
                                <div class="team-card_content">
                                    ...
                                    <?php endif;?>
                                    <h4 class="team-card_title h5"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h4>
                                    <?php if(!empty($team_meta['fitmas_contact_info'])) : ?>
                                        <?php foreach($team_meta['fitmas_contact_info'] as $contact ) : ?>
                                            <a class="link-btn" tabindex="0">
...
Plugin::instance()->widgets_manager->register( new fitmas_Team_two_Widget );