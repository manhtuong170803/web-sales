<?php
namespace Elementor;
class fitmas_header_template_two extends Widget_Base {

	public function get_name() {
		return 'fitmas_header_template_two';
	}

	public function get_title() {
		return esc_html__( 'Fitmas Header Two', 'fitmascore' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
            'enable_top_header',
            [
                'label'        => esc_html__( 'Enable Top Header', 'fitmascore' ),
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .header-layout2 .sticky-wrapper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .header-layout2 .sticky-wrapper.sticky' => 'background-color: {{VALUE}}',
				],
				'condition' => [
					'sticky_menu' => 'yes',
				],
	...
	// ---------------------------------------------
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'   => [
					'{{WRAPPER}} .header-layout2 .header-top' => 'background-color: {{VALUE}};',
				],
			]
		);
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .header-layout2 .header-top' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .header-layout2 .header-top' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		$this->end_controls_section();
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'        => Controls_Manager::COLOR,
				'selectors'   => [
					'{{WRAPPER}} .header-layout2 .navbar-right-desc' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'        => Controls_Manager::COLOR,
				'selectors'   => [
					'{{WRAPPER}} .header-layout2 .navbar-right-desc a' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'type'        => Controls_Manager::COLOR,
				'selectors'   => [
					'{{WRAPPER}} .header-layout2 .navbar-right-desc a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'        => Controls_Manager::COLOR,
				'selectors'   => [
					'{{WRAPPER}} .btn.style2::before' => 'background-color: {{VALUE}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'type'        => Controls_Manager::COLOR,
				'selectors'   => [
					'{{WRAPPER}} .btn.style2' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_responsive_control(
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'        => Controls_Manager::COLOR,
				'selectors'   => [
					'{{WRAPPER}} .btn.style2:hover:before' => 'background-color: {{VALUE}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				'label'       => esc_html__('Hover Text Color', 'fitmascore'),
				'type'        => Controls_Manager::COLOR,
				'selectors'   => [
					'{{WRAPPER}} .btn.style2:hover' => 'color: {{VALUE}};',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'        => Controls_Manager::COLOR,
				'selectors'   => [
					'{{WRAPPER}} .btn.btn-border3:before' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'        => Controls_Manager::COLOR,
				'selectors'   => [
					'{{WRAPPER}} .btn.btn-border3' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .btn.btn-border3:before',
            ]
        );
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'        => Controls_Manager::COLOR,
				'selectors'   => [
					'{{WRAPPER}} .btn.btn-border3:hover,{{WRAPPER}} .btn.btn-border3:focus,{{WRAPPER}} .btn.btn-border3:active,' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
                        ...
                        <div class="header-links">
                            ...
                            <?php foreach($settings['top_bar_list'] as $top_list): ?>
                                <li> 
									...
									<a> <?php echo wp_kses_post($top_list['top_bar_text']); ?> </a>
								</li>
							<?php endforeach; ?>
                            </ul>
                        </div>
                            ...
                            <div class="header-button">
								<?php if (!empty($settings['button_Text'])) : 
									 if ( ! empty( $settings['button_link']['url'] ) ) {
                               		 ...
                               		 <a <?php echo $this->get_render_attribute_string( 'button_link' ); ?> class="btn style2 style-r0 d-xl-block d-none">
...
Plugin::instance()->widgets_manager->register( new fitmas_header_template_two );
?>
