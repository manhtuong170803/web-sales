...
class fitmas_Team_one_Widget extends Widget_Base {

    public function get_name() {

        return 'fitmas_Team_one';
    }

    public function get_title() {
        return esc_html__( 'Fitmas Team V1', 'fitmascore' );
    }
      ...
      $this->add_control(
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'    => esc_html__( 'Background', 'fitmascore' ),
                'types'    => ['classic', 'gradient', 'video'],
                'selector' => '{{WRAPPER}} .team-slider-1 .slick-current .team-card',
            ]
        );
        $this->add_group_control(
            \Elementor\Group_Control_Box_Shadow::get_type(),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .team-slider-1 .slick-current .team-card' => 'border-radius: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .team-area-1 .team-card_img img' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .team-area-1 .team-card_img img' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .team-area-1 .team-card_img img' => 'object-fit: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                'name'     => 'image_border',
                'label'    => esc_html__( 'Border', 'fitmascore' ),
                'selector' => '{{WRAPPER}} .team-area-1 .team-card_img img',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .team-area-1 .team-card_img img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .team-card_img img ',
            ]
        );
        $this->add_responsive_control(
            'image_margin',
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .team-card_img' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .team-card_img' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
    ...
    <div class="team-area-1">
        <div class="<?php echo esc_attr( $container ); ?>">
            <div class="row global-carousel team-slider-1 slider-shadow" data-slide-show="<?php echo esc_attr( $settings['slide_show'] ); ?>" data-ml-slide-show="4" data-lg-slide-show="3" data-md-slide-show="2" data-sm-slide-show="1" data-xs-slide-show="1" data-center-mode="true">
                    ...
                    <div class="team-card">
                        ...
                        <div class="team-card_content">
                            ...
                            <?php if(!empty($team_meta['fitmas_team_stitle'])) : ?>
                                <span class="team-card_desig"><?php  echo esc_html($team_meta['fitmas_team_stitle']);?></span>
                            <?php endif;?>
...
Plugin::instance()->widgets_manager->register( new fitmas_Team_one_Widget );