...
class fitmas_gallery_Widget extends Widget_Base {

    public function get_name() {

        return 'fitmas_gallery';
    }

    public function get_title() {
        return esc_html__( 'Fitmas Gallery', 'fitmascore' );
    }
...
Plugin::instance()->widgets_manager->register( new fitmas_gallery_Widget );